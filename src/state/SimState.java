...
public class SimState extends State {
	...
	public void tick(Point mouse) {
		...
		//		
		sim.setrBase(bm.sliderButtons.get(0).getVal() * 0.1);
		sim.setMortalityRate(bm.sliderButtons.get(1).getVal() * 0.01);
		...
		sim.setMaxSummerMultiplier(bm.sliderButtons.get(5).getVal());
